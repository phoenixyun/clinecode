	...
	return (
		<div style={{}}>
			...
			<VSCodeDropdown
				...
				<VSCodeOption value="Simplified Chinese - 简体中文">简体中文 (Simplified Chinese)</VSCodeOption>
				...
				<VSCodeOption value="Traditional Chinese - 繁體中文">繁體中文 (Traditional Chinese)</VSCodeOption>
				<VSCodeOption value="Turkish - Türkçe">Turkish - Türkçe</VSCodeOption>
			</VSCodeDropdown>
			<p className="text-sm text-description mt-1">{t("settings.preferredLanguageDesc")}</p>
		</div>
	)
}
